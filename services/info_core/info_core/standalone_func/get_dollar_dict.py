...
def get_dollar_dict(
    ...
    # If the local cache is empty, hydrate it from shared reference data even if
    # the shared snapshot is older than the normal freshness threshold. This
    # avoids losing the last known rate during restart windows.
