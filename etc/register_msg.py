...
def register(bot_token, api_url, target_telegram_id, origin, input_type, title, content=None, code=None, sent_switch=0, send_counts=1, remark=None):
    ...
    for each_target_telegram_id in target_telegram_id_list:
        ...
        if response.status_code != 201:
            ...
            new_response = requests.post(api_url, data=json.dumps(data), headers=headers)
