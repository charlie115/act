...
class TradeConfigViewSetSerializer(TradeCoreMixin, serializers.Serializer):
    ...
    target_market_risk_threshold_p = serializers.IntegerField(required=False)
    origin_market_risk_threshold_p = serializers.IntegerField(required=False)
    repeat_limit_p = serializers.IntegerField(required=False)
