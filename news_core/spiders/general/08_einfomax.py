...
class EInfoMaxSpider(scrapy.Spider):
    ...
    start_urls = [
        # International news
        "https://news.einfomax.co.kr/news/articleList.html?sc_section_code=S1N23",
        # Overseas stocks
        "https://news.einfomax.co.kr/news/articleList.html?sc_section_code=S1N21",
    ]
    ...
    def parse(self, response):
        ...
        urls = set()
        for url in response.css("div[id=sections]").css("a::attr(href)").getall():
            try:
    ...
    def parse_articles(self, response):
        ...
        date_time = header.css("div.info-group").css("li")[1].css("::text").get()
